...
const EditJobVacancy = () => {
  ...
  useEffect(() => {
    fetch(`https://district-connect-backend.onrender.com/job/details/${id}`)
      .then((res) => res.json())
      .then((data) => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      const response = await fetch(`https://district-connect-backend.onrender.com/job/updatejob/${id}`, {
        method: "PUT",
