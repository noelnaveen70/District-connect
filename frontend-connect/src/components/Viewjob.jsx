...
const ViewJobsPage = () => {
  ...
  useEffect(() => {
    fetch("https://district-connect-backend.onrender.com/job/displayjobs")
      .then((res) => {
        if (!res.ok) {
  ...
  const handleDelete = async (id) => {
    ...
    try {
      const response = await fetch(`https://district-connect-backend.onrender.com/job/deletejob/${id}`, {
        method: "DELETE",
      });
