...
const EditSchool = () => {
  ...
  useEffect(() => {
    fetch(`https://district-connect-backend.onrender.com/school/details/${id}`)
      .then((res) => res.json())
      .then((data) => {
        setName(data.name);
  ...
  const handleSubmit = async () => {
    ...
    try {
      const response = await fetch(`https://district-connect-backend.onrender.com/school/updateschool/${id}`, {
        method: "PUT",
